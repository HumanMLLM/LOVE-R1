...
"""
    ...
    frame_ids = torch.linspace(0, len(vreader) - 1, 50).round().long().tolist()[1:-1]
    cache_dir = './cache/'
...
OUTPUT_JSONL = "finvideo_output1_answer_cot.jsonl"      # 输出文件（JSON Lines 格式）
